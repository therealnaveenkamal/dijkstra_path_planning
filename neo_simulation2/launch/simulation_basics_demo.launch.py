...
def generate_launch_description():
    ...
    params_node = Node(package='parameter_tests',
                       executable='param_vel', output='screen')

    return LaunchDescription([gazebo, spawn_entity, start_robot_state_publisher_cmd, moving_srv, stop_srv, move_robot_as_launch, params_node])
